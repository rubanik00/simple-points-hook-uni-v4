...
contract TestPointsHook is Test, Deployers {
    ...
    function setUp() public {
        ...
        (, bytes32 salt) = HookMiner.find(
            address(this), flags, 0, type(PointsHook).creationCode, abi.encode(manager, "Points Token", "TEST_POINTS")
        );
    ...
    function test_addLiquidityAndSwap() public {
        ...
        modifyLiquidityRouter.modifyLiquidity{value: 0.003 ether}(
            key, IPoolManager.ModifyLiquidityParams({tickLower: -60, tickUpper: 60, liquidityDelta: 1 ether}), hookData
        );
